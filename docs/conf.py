...
#
# html_title = 'edx-celeryutils v0.1.0'
...
htmlhelp_basename = 'edx-celeryutilsdoc'
...
latex_documents = [
    (master_doc, 'edx-celeryutils.tex', 'edx-celeryutils Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'edx-celeryutils', 'edx-celeryutils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'edx-celeryutils', 'edx-celeryutils Documentation',
     author, 'edx-celeryutils', 'Code to support working with celery',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'celery_utils'),
                os.path.join(root_path, 'celery_utils/migrations')])
